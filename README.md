...
## Project Structure
    ...
    ├── tapthru_merchant_28681  # Django project configurations
...
1. Clone this repo and `cd tapthru_merchant_28681`
...
2. Clone this repo and `cd tapthru_merchant_28681`
